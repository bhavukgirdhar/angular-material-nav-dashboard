...
export interface LedgerItemDefaultsServiceGetReport { 
    type?: LedgerItemDefaultsServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace LedgerItemDefaultsServiceGetReport {
