...
export interface GenericReportServiceGetReportTypeArg { 
    type?: GenericReportServiceGetReportTypeArg.TypeEnum;
    arg?: ReportInput;
}
export namespace GenericReportServiceGetReportTypeArg {
