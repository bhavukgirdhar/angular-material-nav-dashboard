...
export interface DeletedTransactionServiceGetReport { 
    type?: DeletedTransactionServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace DeletedTransactionServiceGetReport {
