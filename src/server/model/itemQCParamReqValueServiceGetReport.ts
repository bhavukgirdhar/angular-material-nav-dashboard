...
export interface ItemQCParamReqValueServiceGetReport { 
    type?: ItemQCParamReqValueServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace ItemQCParamReqValueServiceGetReport {
