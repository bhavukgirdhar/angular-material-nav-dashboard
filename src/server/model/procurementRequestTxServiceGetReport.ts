...
export interface ProcurementRequestTxServiceGetReport { 
    type?: ProcurementRequestTxServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace ProcurementRequestTxServiceGetReport {
