...
export interface LedgerItemDiscountServiceGetReport { 
    type?: LedgerItemDiscountServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace LedgerItemDiscountServiceGetReport {
