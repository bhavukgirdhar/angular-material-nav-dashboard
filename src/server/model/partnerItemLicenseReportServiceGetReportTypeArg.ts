...
export interface PartnerItemLicenseReportServiceGetReportTypeArg { 
    type?: PartnerItemLicenseReportServiceGetReportTypeArg.TypeEnum;
    arg?: PartnerItemLicenseReportArg;
}
export namespace PartnerItemLicenseReportServiceGetReportTypeArg {
