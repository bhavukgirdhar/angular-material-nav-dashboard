...
export interface StitchingItemHistoryReportServiceGetReportTypeArg { 
    type?: StitchingItemHistoryReportServiceGetReportTypeArg.TypeEnum;
    arg?: StitchingItemHistoryReportArgument;
}
export namespace StitchingItemHistoryReportServiceGetReportTypeArg {
