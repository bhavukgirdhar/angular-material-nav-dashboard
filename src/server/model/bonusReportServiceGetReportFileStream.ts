...
export interface BonusReportServiceGetReportFileStream { 
    type?: BonusReportServiceGetReportFileStream.TypeEnum;
    arg?: BonusReportArgument;
}
export namespace BonusReportServiceGetReportFileStream {
