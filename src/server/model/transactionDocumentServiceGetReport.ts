...
export interface TransactionDocumentServiceGetReport { 
    type?: TransactionDocumentServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace TransactionDocumentServiceGetReport {
