...
export interface StockSummaryReportService2GetReportTypeArg { 
    type?: StockSummaryReportService2GetReportTypeArg.TypeEnum;
    arg?: StockSummaryReportInput2;
}
export namespace StockSummaryReportService2GetReportTypeArg {
