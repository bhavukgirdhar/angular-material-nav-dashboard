...
export interface ApplicationResourceServiceGetReport { 
    type?: ApplicationResourceServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace ApplicationResourceServiceGetReport {
