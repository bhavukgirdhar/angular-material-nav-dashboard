...
export interface BonusReportServiceGetReportTypeArg { 
    type?: BonusReportServiceGetReportTypeArg.TypeEnum;
    arg?: BonusReportArgument;
}
export namespace BonusReportServiceGetReportTypeArg {
