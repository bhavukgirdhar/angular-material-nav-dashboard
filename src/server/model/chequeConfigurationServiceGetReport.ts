...
export interface ChequeConfigurationServiceGetReport { 
    type?: ChequeConfigurationServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace ChequeConfigurationServiceGetReport {
