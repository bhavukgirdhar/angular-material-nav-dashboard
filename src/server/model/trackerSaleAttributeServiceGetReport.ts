...
export interface TrackerSaleAttributeServiceGetReport { 
    type?: TrackerSaleAttributeServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace TrackerSaleAttributeServiceGetReport {
