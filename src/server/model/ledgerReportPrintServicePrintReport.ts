...
export interface LedgerReportPrintServicePrintReport { 
    report?: LedgerReport;
    type?: LedgerReportPrintServicePrintReport.TypeEnum;
}
export namespace LedgerReportPrintServicePrintReport {
