...
export interface TrainingTransactionServiceGetReport { 
    type?: TrainingTransactionServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace TrainingTransactionServiceGetReport {
