...
export interface StitchingMeasurementServiceGetReport { 
    type?: StitchingMeasurementServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace StitchingMeasurementServiceGetReport {
