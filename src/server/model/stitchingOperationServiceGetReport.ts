...
export interface StitchingOperationServiceGetReport { 
    type?: StitchingOperationServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace StitchingOperationServiceGetReport {
