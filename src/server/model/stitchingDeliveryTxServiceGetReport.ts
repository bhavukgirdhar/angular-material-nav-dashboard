...
export interface StitchingDeliveryTxServiceGetReport { 
    type?: StitchingDeliveryTxServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace StitchingDeliveryTxServiceGetReport {
