...
export interface VoucherPrintConfigServiceGetReport { 
    type?: VoucherPrintConfigServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace VoucherPrintConfigServiceGetReport {
