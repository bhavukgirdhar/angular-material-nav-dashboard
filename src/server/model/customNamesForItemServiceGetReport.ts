...
export interface CustomNamesForItemServiceGetReport { 
    type?: CustomNamesForItemServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace CustomNamesForItemServiceGetReport {
