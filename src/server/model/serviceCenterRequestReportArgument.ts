...
export interface ServiceCenterRequestReportArgument { 
    dateFrom?: Date;
    dateTo?: Date;
    dueDate?: Date;
    serviceCenterLedger?: ILedger;
    repairItem?: string;
    status?: ServiceCenterRequestReportArgument.StatusEnum;
}
export namespace ServiceCenterRequestReportArgument {
