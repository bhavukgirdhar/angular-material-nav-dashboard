...
export interface AbstractTransactionServiceGetReport { 
    type?: AbstractTransactionServiceGetReport.TypeEnum;
    arg?: ReportContext;
}
export namespace AbstractTransactionServiceGetReport {
