...
import { IStitchingVendorDeliveryLine } from './iStitchingVendorDeliveryLine';
import { ReferenceTxInfo } from './referenceTxInfo';
import { ResourceProxy } from './resourceProxy';


export interface IStitchingVendorDeliveryTx { 
    stitchingVendorDeliveryLines?: Array<IStitchingVendorDeliveryLine>;
    amount?: number;
    vendorId?: number;
    vendorName?: string;
    totalAmount?: number;
