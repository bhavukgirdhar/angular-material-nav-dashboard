 ...
 */
import { IGatePassOutwardItemLine } from './iGatePassOutwardItemLine';
import { ReferenceTxInfo } from './referenceTxInfo';
import { ResourceProxy } from './resourceProxy';


export interface IGatePassOutwardTx { 
    ledgerName?: string;
    ledgerId?: number;
    mandiId?: number;
    mandiName?: string;
    vehicleNo?: string;
    agentGatePassNo?: string;
    gatePassOutwardItemLines?: Array<IGatePassOutwardItemLine>;
